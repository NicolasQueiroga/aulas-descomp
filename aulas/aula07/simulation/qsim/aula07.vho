...
SIGNAL \CPU|FLIPFLOP1|DOUT~3_combout\ : std_logic;
SIGNAL \CPU|FLIPFLOP1|DOUT~4_combout\ : std_logic;
...
SIGNAL \CPU|FLIPFLOP1|ALT_INV_DOUT~0_combout\ : std_logic;
...
SIGNAL \CPU|FLIPFLOP1|ALT_INV_DOUT~3_combout\ : std_logic;
...
\CPU|FLIPFLOP1|ALT_INV_DOUT~0_combout\ <= NOT \CPU|FLIPFLOP1|DOUT~0_combout\;
...
\CPU|FLIPFLOP1|ALT_INV_DOUT~3_combout\ <= NOT \CPU|FLIPFLOP1|DOUT~3_combout\;
...
-- Equation(s):
-- \ROM1|memROM~6_combout\ = (!\CPU|PC|DOUT\(7) & (!\CPU|PC|DOUT\(8) & (\ROM1|memROM~1_combout\ & \ROM1|memROM~5_combout\)))
...
-- Equation(s):
-- \ROM1|memROM~12_combout\ = (!\CPU|PC|DOUT\(3) & (!\CPU|PC|DOUT\(2) & (!\CPU|PC|DOUT\(0) $ (!\CPU|PC|DOUT\(1))))) # (\CPU|PC|DOUT\(3) & ((!\CPU|PC|DOUT\(0) & (!\CPU|PC|DOUT\(1))) # (\CPU|PC|DOUT\(0) & ((\CPU|PC|DOUT\(2))))))
...
-- Equation(s):
-- \ROM1|memROM~14_combout\ = (!\CPU|PC|DOUT\(3) & (!\CPU|PC|DOUT\(0) $ ((!\CPU|PC|DOUT\(1))))) # (\CPU|PC|DOUT\(3) & ((!\CPU|PC|DOUT\(2) & (!\CPU|PC|DOUT\(0))) # (\CPU|PC|DOUT\(2) & ((!\CPU|PC|DOUT\(1))))))
...
-- Equation(s):
-- \ROM1|memROM~16_combout\ = (!\CPU|PC|DOUT\(0) & (!\CPU|PC|DOUT\(1) & (!\CPU|PC|DOUT\(2) & !\CPU|PC|DOUT\(3)))) # (\CPU|PC|DOUT\(0) & (\CPU|PC|DOUT\(1) & ((\CPU|PC|DOUT\(3)) # (\CPU|PC|DOUT\(2)))))
...
-- Equation(s):
-- \CPU|DECODER_INSTRU|Equal10~0_combout\ = ( \ROM1|memROM~16_combout\ & ( (\ROM1|memROM~9_combout\ & (\ROM1|memROM~10_combout\ & (!\ROM1|memROM~12_combout\ & !\ROM1|memROM~14_combout\))) ) )
...
-- Equation(s):
-- \ROM1|memROM~1_combout\ = (!\CPU|PC|DOUT\(4) & (!\CPU|PC|DOUT\(5) & !\CPU|PC|DOUT\(6)))
...
-- Equation(s):
-- \ROM1|memROM~8_combout\ = (!\CPU|PC|DOUT\(7) & (!\CPU|PC|DOUT\(8) & (\ROM1|memROM~1_combout\ & \ROM1|memROM~7_combout\)))
...
-- Equation(s):
-- \CPU|DESVIO1|Sel[1]~0_combout\ = (\ROM1|memROM~11_combout\ & ((!\ROM1|memROM~17_combout\ & (\ROM1|memROM~15_combout\ & \ROM1|memROM~13_combout\)) # (\ROM1|memROM~17_combout\ & (!\ROM1|memROM~15_combout\ & !\ROM1|memROM~13_combout\))))
...
-- Equation(s):
-- \CPU|DESVIO1|comb~3_combout\ = ( !\CPU|DESVIO1|Sel[1]~0_combout\ & ( (!\ROM1|memROM~11_combout\ & (\ROM1|memROM~13_combout\ & (!\ROM1|memROM~15_combout\ & \ROM1|memROM~17_combout\))) ) )
...
-- Equation(s):
-- \CPU|DESVIO1|comb~2_combout\ = ((!\ROM1|memROM~13_combout\) # ((!\ROM1|memROM~17_combout\) # (\ROM1|memROM~15_combout\))) # (\ROM1|memROM~11_combout\)
...
-- Equation(s):
-- \CPU|MUX2|MUX_OUT[8]~8_combout\ = (!\CPU|DESVIO1|Sel\(0) & ((!\CPU|DESVIO1|Sel\(1) & ((\CPU|incrementaPC|Add0~33_sumout\))) # (\CPU|DESVIO1|Sel\(1) & (\CPU|END_RETORNO|DOUT\(8)))))
...
-- Equation(s):
-- \ROM1|memROM~4_combout\ = (!\CPU|PC|DOUT\(7) & (!\CPU|PC|DOUT\(8) & (\ROM1|memROM~1_combout\ & \ROM1|memROM~3_combout\)))
...
-- Equation(s):
-- \ROM1|memROM~9_combout\ = (!\CPU|PC|DOUT\(0) & (!\CPU|PC|DOUT\(3) $ (((!\CPU|PC|DOUT\(1) & \CPU|PC|DOUT\(2))))))
...
-- Equation(s):
-- \CPU|DECODER_INSTRU|saida~0_combout\ = (!\ROM1|memROM~17_combout\ & (!\ROM1|memROM~13_combout\ & (!\ROM1|memROM~15_combout\ $ (!\ROM1|memROM~11_combout\))))
...
-- Equation(s):
-- \CPU|DECODER_INSTRU|saida~1_combout\ = (!\ROM1|memROM~17_combout\ & (!\ROM1|memROM~15_combout\ $ (((!\ROM1|memROM~13_combout\ & !\ROM1|memROM~11_combout\)))))
...
PORT MAP (
	...
	asdata => \~GND~combout\,
	sload => \CPU|DECODER_INSTRU|saida~0_combout\,
	ena => \CPU|DECODER_INSTRU|saida~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \CPU|REGA|DOUT\(4));
...
-- Equation(s):
-- \ROM1|memROM~21_combout\ = (!\ROM1|memROM~1_combout\) # (!\ROM1|memROM~7_combout\)
...
-- Equation(s):
-- \ROM1|memROM~20_combout\ = (!\ROM1|memROM~1_combout\) # (!\ROM1|memROM~5_combout\)
...
-- Equation(s):
-- \ROM1|memROM~19_combout\ = (!\ROM1|memROM~1_combout\) # (!\ROM1|memROM~3_combout\)
...
-- Equation(s):
-- \CPU|ULA1|Add0~17_sumout\ = SUM(( ((!\ROM1|memROM~18_combout\) # (\CPU|PC|DOUT\(7))) # (\CPU|PC|DOUT\(8)) ) + ( \CPU|REGA|DOUT\(0) ) + ( \CPU|ULA1|Add0~34_cout\ ))
-- \CPU|ULA1|Add0~18\ = CARRY(( ((!\ROM1|memROM~18_combout\) # (\CPU|PC|DOUT\(7))) # (\CPU|PC|DOUT\(8)) ) + ( \CPU|REGA|DOUT\(0) ) + ( \CPU|ULA1|Add0~34_cout\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111110000000000000000000000001111111100111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \CPU|PC|ALT_INV_DOUT\(8),
...
-- Equation(s):
-- \CPU|ULA1|Add0~21_sumout\ = SUM(( ((\ROM1|memROM~19_combout\) # (\CPU|PC|DOUT\(7))) # (\CPU|PC|DOUT\(8)) ) + ( \CPU|REGA|DOUT\(1) ) + ( \CPU|ULA1|Add0~18\ ))
-- \CPU|ULA1|Add0~22\ = CARRY(( ((\ROM1|memROM~19_combout\) # (\CPU|PC|DOUT\(7))) # (\CPU|PC|DOUT\(8)) ) + ( \CPU|REGA|DOUT\(1) ) + ( \CPU|ULA1|Add0~18\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111110000000000000000000000000011111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \CPU|PC|ALT_INV_DOUT\(8),
...
-- Equation(s):
-- \CPU|ULA1|Add0~25_sumout\ = SUM(( ((\ROM1|memROM~20_combout\) # (\CPU|PC|DOUT\(7))) # (\CPU|PC|DOUT\(8)) ) + ( \CPU|REGA|DOUT\(2) ) + ( \CPU|ULA1|Add0~22\ ))
-- \CPU|ULA1|Add0~26\ = CARRY(( ((\ROM1|memROM~20_combout\) # (\CPU|PC|DOUT\(7))) # (\CPU|PC|DOUT\(8)) ) + ( \CPU|REGA|DOUT\(2) ) + ( \CPU|ULA1|Add0~22\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add0~29_sumout\ = SUM(( ((\ROM1|memROM~21_combout\) # (\CPU|PC|DOUT\(7))) # (\CPU|PC|DOUT\(8)) ) + ( \CPU|REGA|DOUT\(3) ) + ( \CPU|ULA1|Add0~26\ ))
-- \CPU|ULA1|Add0~30\ = CARRY(( ((\ROM1|memROM~21_combout\) # (\CPU|PC|DOUT\(7))) # (\CPU|PC|DOUT\(8)) ) + ( \CPU|REGA|DOUT\(3) ) + ( \CPU|ULA1|Add0~26\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add0~1_sumout\ = SUM(( VCC ) + ( \CPU|REGA|DOUT\(4) ) + ( \CPU|ULA1|Add0~30\ ))
-- \CPU|ULA1|Add0~2\ = CARRY(( VCC ) + ( \CPU|REGA|DOUT\(4) ) + ( \CPU|ULA1|Add0~30\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add0~5_sumout\ = SUM(( VCC ) + ( \CPU|REGA|DOUT\(5) ) + ( \CPU|ULA1|Add0~2\ ))
-- \CPU|ULA1|Add0~6\ = CARRY(( VCC ) + ( \CPU|REGA|DOUT\(5) ) + ( \CPU|ULA1|Add0~2\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add0~9_sumout\ = SUM(( VCC ) + ( \CPU|REGA|DOUT\(6) ) + ( \CPU|ULA1|Add0~6\ ))
-- \CPU|ULA1|Add0~10\ = CARRY(( VCC ) + ( \CPU|REGA|DOUT\(6) ) + ( \CPU|ULA1|Add0~6\ ))
...
-- Equation(s):
-- \CPU|ULA1|Add0~13_sumout\ = SUM(( VCC ) + ( \CPU|REGA|DOUT\(7) ) + ( \CPU|ULA1|Add0~10\ ))
...
-- Equation(s):
-- \CPU|FLIPFLOP1|DOUT~0_combout\ = ( \ROM1|memROM~16_combout\ & ( (!\ROM1|memROM~9_combout\ & (\ROM1|memROM~10_combout\ & (!\ROM1|memROM~12_combout\ & !\ROM1|memROM~14_combout\))) ) )
...
-- Equation(s):
-- \CPU|FLIPFLOP1|DOUT~1_combout\ = ( !\CPU|ULA1|Add0~29_sumout\ & ( \CPU|FLIPFLOP1|DOUT~0_combout\ & ( (!\CPU|DECODER_INSTRU|saida~0_combout\ & (!\CPU|ULA1|Add0~17_sumout\ & (!\CPU|ULA1|Add0~21_sumout\ & !\CPU|ULA1|Add0~25_sumout\))) ) ) )
...
PORT MAP (
	...
	dataf => \CPU|FLIPFLOP1|ALT_INV_DOUT~0_combout\,
	combout => \CPU|FLIPFLOP1|DOUT~1_combout\);

\CPU|FLIPFLOP1|DOUT~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \CPU|FLIPFLOP1|DOUT~2_combout\ = ( \CPU|FLIPFLOP1|DOUT~0_combout\ & ( (!\ROM1|memROM~2_combout\ & (!\ROM1|memROM~4_combout\ & (!\ROM1|memROM~6_combout\ & !\ROM1|memROM~8_combout\))) ) )
...
PORT MAP (
	...
	datae => \CPU|FLIPFLOP1|ALT_INV_DOUT~0_combout\,
	combout => \CPU|FLIPFLOP1|DOUT~2_combout\);

\CPU|FLIPFLOP1|DOUT~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \CPU|FLIPFLOP1|DOUT~3_combout\ = (!\CPU|FLIPFLOP1|DOUT~q\ & (\CPU|DECODER_INSTRU|saida~0_combout\ & ((\CPU|FLIPFLOP1|DOUT~2_combout\)))) # (\CPU|FLIPFLOP1|DOUT~q\ & ((!\CPU|FLIPFLOP1|DOUT~0_combout\) # ((\CPU|DECODER_INSTRU|saida~0_combout\ & 
-- \CPU|FLIPFLOP1|DOUT~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \CPU|FLIPFLOP1|ALT_INV_DOUT~q\,
	datab => \CPU|DECODER_INSTRU|ALT_INV_saida~0_combout\,
	datac => \CPU|FLIPFLOP1|ALT_INV_DOUT~0_combout\,
	datad => \CPU|FLIPFLOP1|ALT_INV_DOUT~2_combout\,
	combout => \CPU|FLIPFLOP1|DOUT~3_combout\);

\CPU|FLIPFLOP1|DOUT~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \CPU|FLIPFLOP1|DOUT~4_combout\ = ( \CPU|FLIPFLOP1|DOUT~1_combout\ & ( \CPU|FLIPFLOP1|DOUT~3_combout\ ) ) # ( !\CPU|FLIPFLOP1|DOUT~1_combout\ & ( \CPU|FLIPFLOP1|DOUT~3_combout\ ) ) # ( \CPU|FLIPFLOP1|DOUT~1_combout\ & ( !\CPU|FLIPFLOP1|DOUT~3_combout\ & ( 
-- (!\CPU|ULA1|Add0~1_sumout\ & (!\CPU|ULA1|Add0~5_sumout\ & (!\CPU|ULA1|Add0~9_sumout\ & !\CPU|ULA1|Add0~13_sumout\))) ) ) )
...
PORT MAP (
	...
	dataf => \CPU|FLIPFLOP1|ALT_INV_DOUT~3_combout\,
	combout => \CPU|FLIPFLOP1|DOUT~4_combout\);
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \CPU|FLIPFLOP1|DOUT~4_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \CPU|DESVIO1|comb~1_combout\ = ( \CPU|FLIPFLOP1|DOUT~q\ & ( (!\ROM1|memROM~13_combout\ & (\ROM1|memROM~11_combout\ & (!\ROM1|memROM~15_combout\ & \ROM1|memROM~17_combout\))) # (\ROM1|memROM~13_combout\ & (((\ROM1|memROM~15_combout\ & 
-- !\ROM1|memROM~17_combout\)))) ) ) # ( !\CPU|FLIPFLOP1|DOUT~q\ & ( (!\ROM1|memROM~11_combout\ & (\ROM1|memROM~13_combout\ & (\ROM1|memROM~15_combout\ & !\ROM1|memROM~17_combout\))) # (\ROM1|memROM~11_combout\ & (!\ROM1|memROM~13_combout\ & 
-- (!\ROM1|memROM~15_combout\ & \ROM1|memROM~17_combout\))) ) )
...
-- Equation(s):
-- \CPU|DESVIO1|comb~0_combout\ = ( \CPU|DESVIO1|Sel[1]~0_combout\ & ( \CPU|FLIPFLOP1|DOUT~q\ & ( (!\ROM1|memROM~15_combout\ & ((!\ROM1|memROM~17_combout\) # (!\ROM1|memROM~11_combout\ $ (\ROM1|memROM~13_combout\)))) # (\ROM1|memROM~15_combout\ & 
-- (((!\ROM1|memROM~13_combout\) # (\ROM1|memROM~17_combout\)))) ) ) ) # ( !\CPU|DESVIO1|Sel[1]~0_combout\ & ( \CPU|FLIPFLOP1|DOUT~q\ & ( (!\ROM1|memROM~13_combout\ & ((!\ROM1|memROM~11_combout\) # ((!\ROM1|memROM~17_combout\) # (\ROM1|memROM~15_combout\)))) 
-- # (\ROM1|memROM~13_combout\ & (((!\ROM1|memROM~15_combout\) # (\ROM1|memROM~17_combout\)))) ) ) ) # ( \CPU|DESVIO1|Sel[1]~0_combout\ & ( !\CPU|FLIPFLOP1|DOUT~q\ & ( (!\ROM1|memROM~11_combout\ & ((!\ROM1|memROM~13_combout\) # (!\ROM1|memROM~15_combout\ $ 
-- (\ROM1|memROM~17_combout\)))) # (\ROM1|memROM~11_combout\ & (((!\ROM1|memROM~17_combout\) # (\ROM1|memROM~15_combout\)) # (\ROM1|memROM~13_combout\))) ) ) ) # ( !\CPU|DESVIO1|Sel[1]~0_combout\ & ( !\CPU|FLIPFLOP1|DOUT~q\ & ( (!\ROM1|memROM~11_combout\ & 
-- ((!\ROM1|memROM~13_combout\) # ((!\ROM1|memROM~15_combout\) # (\ROM1|memROM~17_combout\)))) # (\ROM1|memROM~11_combout\ & (((!\ROM1|memROM~17_combout\) # (\ROM1|memROM~15_combout\)) # (\ROM1|memROM~13_combout\))) ) ) )
...
-- Equation(s):
-- \ROM1|memROM~2_combout\ = (!\CPU|PC|DOUT\(7) & (!\CPU|PC|DOUT\(8) & (\ROM1|memROM~0_combout\ & \ROM1|memROM~1_combout\)))
